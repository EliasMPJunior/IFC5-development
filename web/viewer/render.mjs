...
var tileSet = [];
var loadedTiles = /* @__PURE__ */ new Set();
var pendingTiles = /* @__PURE__ */ new Set();
...
function setStreamingTiles(tiles) {
  tileSet = tiles.slice();
}
function enableStreaming(flag) {
